...
public:
	...
	virtual bool Create(int width, int height, int bits_per_piexl, int image_origin = 0);
	...
	virtual void Show(HDC dc, int x, int y, int width, int height, int from_x = 0, int form_y = 0);
	/* draw the current image ROI to the specified rectangle of the destination DC */
	virtual void DrawToHDC(HDC hSCDst, RECT* pDstRect);
#endif
